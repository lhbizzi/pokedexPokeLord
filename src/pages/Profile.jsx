...
export const Profile = ({ pokemonData }) => {
    ...
    }, [navigate, pokemonData]); // Incluindo 'navigate' e 'pokemonData' no array de dependências
                ...
                <Paper elevation={3}>
                    <Box display="flex" justifyContent="center" alignItems="center" p={5} flexDirection="column">
                        ...
                        <Box width={'100%'} alignItems={'center'} justifyContent={'center'}>
                            ...
                            <Box display='flex' justifyContent='space-between' marginBottom={'40px'} marginLeft={'15px'} >
                                <Box marginLeft={'40px'}>
                                ...
                                <Box marginRight={'40px'}>
                                    <Typography>Versão Feminina Shiny</Typography>
                                </Box>
                            </Box>
